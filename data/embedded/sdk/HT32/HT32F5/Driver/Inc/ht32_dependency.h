...
/* Dependency check ----------------------------------------------------------------------------------------*/
#define MIN_HT32_FWLIB_VER              (0x005)
#define MIN_HT32_FWLIB_SVN              (0x2200)
#include "ht32_dependency.h" // Not exist means the the version of HT32 Firmware Library is older than the module required.
