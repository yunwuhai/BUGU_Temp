...
type OverloadInput struct {
	*gorm.Model
	OIIntroduction string `json:"oi_introduction" gorm:"type:varchar(255)"`
	OIType         string `json:"oi_type" gorm:"type:varchar(16)"`
	OverloadID     uint   `json:"overload_id" gorm:"type:varchar(64)"`
}
