...
type CreateModuleRequest struct {
	...
	IsFunc             uint   `form:"is_func" binding:"required"`
}
...
func (svc *Service) CreateModule(param *CreateModuleRequest) error {
	return svc.dao.CreateModule(param.ModuleName, param.ModuleIntroduction, param.PluginName, param.IsFunc)
}

func (svc *Service) UpdateModule(param *UpdateModuleRequest) error {
	return svc.dao.UpdateModule(param.ID, param.ModuleName, param.ModuleIntroduction, param.PluginName, param.IsFunc)
}
